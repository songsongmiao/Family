...
public class LoadProgressBar extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getMeasuredWidth(), RefreshUtils.dip2px(getContext(), 40));
    }
    ...
    private void ensureAnimation(boolean forceReStart) {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                while (parent != null && !(parent instanceof NestedRefresh) && !(parent instanceof SimpleRefresh)) {
