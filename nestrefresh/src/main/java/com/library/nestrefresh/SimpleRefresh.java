...
public class SimpleRefresh extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SimpleRefresh(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SimpleRefresh(Context context, AttributeSet attrs, int defStyleAttr) {
