 ...
 */
public class OverScrollScrollView extends ScrollView implements ScrollerImp.OverScrollable {

	private ScrollerImp mOverScrollDelegate;
	...
	private void createOverScrollDelegate(Context context) {
		mOverScrollDelegate = new ScrollerImp(this);
	}
	...
	@Override
	public ScrollerImp getOverScrollDelegate() {
